...
function Navbar(props) {    
    return(
        <div className="mb-6 md:mb-8 lg:mb-10 flex flex-row text-white justify-evenly">
            ...
            <button className="transition-1 duration-700 hover:scale-110 font-display text-xs sm:text-xs md:text-sm lg:text-base text-white font-light" onClick={() => window.open(resume, "_blank")}>Resume</button>
