...
function Projects() {
    return(
        <div className="animate-in fade-in-5 slide-in-from-bottom-5 duration-1000 flex flex-col gap-10">
            <Card url="https://github.com/philipchen05/ride-ti-reporter" name="RIDE-TI Reporter" tools="Python, Flask, Next.js, TypeScript, Firebase, Tailwind CSS" description="A software tool for automating the production of PROD and UAT defect reports for the Ministry of Finance." />
