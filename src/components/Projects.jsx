...
function Projects() {
    return(
        <div className="animate-in fade-in-5 slide-in-from-bottom-5 duration-1000 flex flex-col gap-10">
            ...
            <Card url="https://github.com/philipchen05/iss-tracker" name="ISS TRACKER" tools="Node.js, React, JavaScript, Axios, Tailwind CSS" description="A live International Space Station (ISS) tracker created with React that displays the location of the ISS on a world map. Accessible at www.whereistheiss.io." />
            <Card url="https://github.com/kevinyvv/memoir" name="MEMOIR" tools="Python, Flask, MongoDB, React, JavaScript, Tailwind CSS" description="A full-stack social media app for sharing and connecting with others through nostalgic memories (UofTHacks 11 Project)." />
