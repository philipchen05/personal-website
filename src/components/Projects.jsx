...
function Projects() {
    return(
        <div className="animate-in fade-in-5 slide-in-from-bottom-5 duration-1000 flex flex-col gap-10">
            ...
            <Card url="https://github.com/philipchen05/students-of-watan" name="Students of Watan" tools="C++" description="Settlers of Catan, but with a Waterloo twist. A fully-fledged turn-based strategy game built in C++ with resource trading and randomized map generation." />
